...
API_KEY = "xteJ75JmUPYfP1XrWWihmtNXfcibgUt-MW_mIE31TMUl"
...
def index():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/fbc1dd83-3ef4-4945-833f-74e2b0cace90/predictions?version=2021-06-07', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
